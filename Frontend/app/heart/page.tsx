    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto max-w-4xl py-6 flex-1">
        <div className="rounded-lg border p-8 shadow-sm">
          <h1 className="mb-6 text-3xl font-bold">Heart Disease Risk Assessment</h1>
          <p className="mb-8 text-muted-foreground">
            This form will be implemented to collect health metrics for heart disease risk prediction.
          </p>
